function one_box_deb_constT_Input_driver(Is,Ic,dIs,dIc)
...
matfldir=[sstrs{1},'/one_bug_model/mat_files/constT/'];
...
iofile=[matfldir,'one_box_deb_constT_Is',num2str(Is),'_Ic',num2str(Ic),'_dIs',num2str(dIs),'_dIc',num2str(dIc),'_plastic.mat'];
